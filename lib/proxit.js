            ...
            if (options.host) {
                functions.push((function(options, endpoint) {
                    ...
                    return function(req, res, next) {
                        ...
                        res.end = function() {
                            log.verbose.http(req.method, res.statusCode, url.format(url.parse(req.url.replace(options.route, endpoint))) + ' (' + req.url + ')');
                ...
                functions.push((function() {
                    ...
                    return function(req, res, next) {
                        ...
                        res.end = function() {
                            log.verbose.http(req.method, res.statusCode, path.normalize(dir + '/' + modifiedUrl) + ' (' + req.url + ')');
                            return end.apply(this,arguments);
                        };
